(function () {
  ...
  const translations = {
    es: {
      ...
      educationHeading: ['Student-Athlete', 'Academico', 'Escuela y GPA.'], contactHeading: ['Contacto', 'Contacto Directo', 'Disponibilidad y perfil academico.'], contactLabels: ['Email Principal', 'Estado Actual', 'Mejor Encaje'], contactButtons: ['Enviar Email', 'Guardar en PDF'], referencesNote: 'Referencias a solicitud.', footer: 'Rocco Loprestti. Perfil de rugby.', toast: 'Email copiado'
    },
    fr: {
      ...
      educationHeading: ['Student-Athlete', 'Academique', 'Ecole et GPA.'], contactHeading: ['Contact', 'Contact Direct', 'Disponibilite et profil academique.'], contactLabels: ['Email Principal', 'Statut Actuel', 'Meilleur Profil'], contactButtons: ['Envoyer un Email', 'Enregistrer en PDF'], referencesNote: 'References sur demande.', footer: 'Rocco Loprestti. Profil rugby.', toast: 'Email copie'
    },
    it: {
      ...
      educationHeading: ['Student-Athlete', 'Accademico', 'Scuola e GPA.'], contactHeading: ['Contatto', 'Contatto Diretto', 'Disponibilita e profilo accademico.'], contactLabels: ['Email Principale', 'Stato Attuale', 'Profilo Migliore'], contactButtons: ['Invia Email', 'Salva in PDF'], referencesNote: 'Referenze su richiesta.', footer: 'Rocco Loprestti. Profilo rugby.', toast: 'Email copiato'
    }
  };
